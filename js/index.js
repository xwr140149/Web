...
//                var a=document.createElement("div")
        ...
        for(var i=0;i<ball.length;i++){
            ...
            //balls[i].style.bacgroundImage=url("pf_r2_c2.png");
            // var r=parseFloat(balls[i].style.width)/2;
            console.log(r);
            var v=i*570;
            var flag=flag;
//                    让球动起来
...
//                    y等于Y轴，top值
            ...
            // console.log(ball["r"]/2);
            // console.log(Math.cos(v/360)*r);
            // console.log(r);
            // console.log(x);
            balls.style.top=y+"px";
            balls.style.left=x+"px";
            
            // console.log(balls.style.top);
        },30);
    }
